(function ($) {
    $(window).on('load', function () {
        var templates = {
            gallery_select_option : '<option value="photoshow">PhotoShow</option>',
            gallery_select : '' +
                '<label class="setting">' +
                    '<span>Theme</span>' +
                    '<select class="theme" data-setting="theme">' +
                        '<option value="default" selected>Default</option>' +
                        '<option value="photoshow">PhotoShow</option>' +
                    '</select>' +
                '</label>'
        };
        ...
        /*
            Providing an interface to allow the user to set/override PS globals would require a couple of things:
